    ...
    (event: any) => {
      ...
      switch (event.target.value) {
        case 'SALE13': {
          ...
          const updateValue3 = getPercentageDiff(amount.enterprize, 13);
          setAmount({
            ...amount,
        ...
        case 'SALE25': {
          ...
          const updateValue3 = getPercentageDiff(amount.enterprize, 25);
          setAmount({
            ...amount,
            starter: updateValue,
            premium: updateValue2,
        ...
        case 'SALE40': {
          const updateValue = getPercentageDiff(amount.enterprize, 40);
          const updateValue2 = getPercentageDiff(amount.premium, 40);
          const updateValue3 = getPercentageDiff(amount.enterprize, 40);
          setAmount({
            ...amount,
            starter: updateValue,
            premium: updateValue2,
        ...
        <div className="App-header">
          ...
          <Row className="width-100" gutter={[24, 24]}>
            <Col className="gutter-row" span={8}>
              ...
              />
              {isError && <Text type="danger">Code does not exit</Text>}
            </Col>
          </Row>
        </div>
      </div>
